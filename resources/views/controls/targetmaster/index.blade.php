                                ...
                                @foreach ($TargetH as $TargetH)
                                    <tr data-entry-id="{{ $TargetH->TargetID }}">
                                        ...
                                        <td>
                                            ...
                                            <a href="#" id="{{ $TargetH->TargetID }}" data-route="/SalesAnalysis/controls/targetmaster/" data-method="DELETE" class="delete-btn btn btn-xs btn-danger"><i class="fa fa-trash-o"></i> @lang('global.app_delete')</a>
                                        </td>
                                        <td>
