...
@section('content')
    ...
    <div class="box box-danger">
        <div class="box-header with-border">
            ...
            <div class="box-tools">
                <a href="{{ route('admin.abilities.create') }}" class="btn btn-sm btn-success">@lang('global.app_new') @lang('global.abilities.title')</a>                      
            </div>
        </div>
                        ...
                        @foreach ($abilities as $ability)
                            <tr data-entry-id="{{ $ability->id }}">
                                ...
                                <td>
                                    ...
                                    <a href="#" id="{{ $ability->id }}" data-route="/admin/abilities/" data-method="DELETE" class="delete-btn btn btn-xs btn-danger">@lang('global.app_delete')</a>
                                    <!-- {!! Form::open(array(
