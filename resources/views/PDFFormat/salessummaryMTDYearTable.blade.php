...
<div style="position: absolute; bottom: 0px; top: 75px; left: 0px; right: 0px; ">
    ...
    @php    
        ...
        $achieveBahtJanuary = (($currBahtJanuary * 100) / (getAmount($targetAMB->Amt01) + getAmount($targetMCB->Amt01)));          
        $achieveBahtFebruary = (($currBahtFebruary * 100) / (getAmount($targetAMB->Amt02) + getAmount($targetMCB->Amt02)));
        $achieveBahtMarch = (($currBahtMarch * 100) / (getAmount($targetAMB->Amt03) + getAmount($targetMCB->Amt03)));
        $achieveBahtApril = (($currBahtApril * 100) / (getAmount($targetAMB->Amt04) + getAmount($targetMCB->Amt04)));
        $achieveBahtMay = (($currBahtMay * 100) / (getAmount($targetAMB->Amt05) + getAmount($targetMCB->Amt05)));
        $achieveBahtJune = (($currBahtJune * 100) / (getAmount($targetAMB->Amt06) + getAmount($targetMCB->Amt06)));
        $achieveBahtJuly = (($currBahtJuly * 100) / (getAmount($targetAMB->Amt07) + getAmount($targetMCB->Amt07)));
        $achieveBahtAugust = (($currBahtAugust * 100) / (getAmount($targetAMB->Amt08) + getAmount($targetMCB->Amt08)));
        $achieveBahtSeptember = (($currBahtSeptember * 100) / (getAmount($targetAMB->Amt09) + getAmount($targetMCB->Amt09)));
        $achieveBahtOctober = (($currBahtOctober * 100) / (getAmount($targetAMB->Amt10) + getAmount($targetMCB->Amt10)));
        $achieveBahtNovember = (($currBahtNovember * 100) / (getAmount($targetAMB->Amt11) + getAmount($targetMCB->Amt11)));
        $achieveBahtDecember = (($currBahtDecember * 100) / (getAmount($targetAMB->Amt12) + getAmount($targetMCB->Amt12)));      
        $achieveBahtTotal = ($currTotalBaht * 100) / calZero($totalBahtTarget);
        $achieveBahtQ1 = (($currBahtQ1 * 100) / (getAmount($targetAMB->AmtQ1) + getAmount($targetMCB->AmtQ1)));     
        $achieveUnitQ1 = (($currUnitQ1 * 100) / (getAmount($targetAMB->UnitQ1) + getAmount($targetMCB->UnitQ1))); 
        $achieveBahtQ2 = (($currBahtQ2 * 100) / (getAmount($targetAMB->AmtQ2) + getAmount($targetMCB->AmtQ2)));     
        $achieveUnitQ2 = (($currUnitQ2 * 100) / (getAmount($targetAMB->UnitQ2) + getAmount($targetMCB->UnitQ2))); 
        $achieveBahtQ3 = (($currBahtQ3 * 100) / (getAmount($targetAMB->AmtQ3) + getAmount($targetMCB->AmtQ3)));     
        $achieveUnitQ3 = (($currUnitQ3 * 100) / (getAmount($targetAMB->UnitQ3) + getAmount($targetMCB->UnitQ3))); 
        $achieveBahtQ4 = (($currBahtQ4 * 100) / (getAmount($targetAMB->AmtQ4) + getAmount($targetMCB->AmtQ4)));     
        $achieveUnitQ4 = (($currUnitQ4 * 100) / (getAmount($targetAMB->UnitQ4) + getAmount($targetMCB->UnitQ4))); 
        ...
        $achieveUnitJanuary = (($currUnitJanuary * 100) / (getAmount($targetAMB->Unit01) + getAmount($targetMCB->Unit01)));        
        $achieveUnitFebruary = (($currUnitFebruary * 100) / (getAmount($targetAMB->Unit02) + getAmount($targetMCB->Unit02)));
        $achieveUnitMarch = (($currUnitMarch * 100) / (getAmount($targetAMB->Unit03) + getAmount($targetMCB->Unit03)));
        $achieveUnitApril = (($currUnitApril * 100) / (getAmount($targetAMB->Unit04) + getAmount($targetMCB->Unit04)));
        $achieveUnitMay = (($currUnitMay * 100) / (getAmount($targetAMB->Unit05) + getAmount($targetMCB->Unit05)));
        $achieveUnitJune = (($currUnitJune * 100) / (getAmount($targetAMB->Unit06) + getAmount($targetMCB->Unit06)));
        $achieveUnitJuly = (($currUnitJuly * 100) / (getAmount($targetAMB->Unit07) + getAmount($targetMCB->Unit07)));
        $achieveUnitAugust = (($currUnitAugust * 100) / (getAmount($targetAMB->Unit08) + getAmount($targetMCB->Unit08)));
        $achieveUnitSeptember = (($currUnitSeptember * 100) / (getAmount($targetAMB->Unit09) + getAmount($targetMCB->Unit09)));
        $achieveUnitOctober = (($currUnitOctober * 100) / (getAmount($targetAMB->Unit10) + getAmount($targetMCB->Unit10)));
        $achieveUnitNovember = (($currUnitNovember * 100) / (getAmount($targetAMB->Unit11) + getAmount($targetMCB->Unit11)));
        $achieveUnitDecember = (($currUnitDecember * 100) / (getAmount($targetAMB->Unit12) + getAmount($targetMCB->Unit12)));
