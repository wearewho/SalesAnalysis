         ...
         <div class="row">
            ...
            <div class="box box-danger">
                ...
                <div class="box-header with-border">
                    <h3 class="box-title">Target Master Head</h3>
                    <div class="box-tools">       
                    </div>
                </div>
                <div class="box-body">
            ...
            <div class="col-xs-12" >
              <div class="box box-danger" style="width: 220%;">
                ...
                <div class="box-body table-responsive">
                  <table class="table table-bordered" border="1" align="center" cellpadding="3" cellspacing="1">
                        ...
                        @include('partials.editItemgroup')
