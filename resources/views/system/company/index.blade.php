                    ...
                    @if (count($company) > 0)
                        @foreach ($company as $company)
                            <tr data-entry-id="{{ $company->CompanyID }}">
                                ...
                                <td>
                                    <a href="{{ route('system.company.edit',[$company->CompanyID]) }}" class="btn btn-xs btn-info">@lang('global.app_edit')</a>
                                    <a href="#" id="{{ $company->CompanyID }}" data-route="/system/company/" data-method="DELETE" class="delete-btn btn btn-xs btn-danger">@lang('global.app_delete')</a>
                                   <!-- {!! Form::open(array(
