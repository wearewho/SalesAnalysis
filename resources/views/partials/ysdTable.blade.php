        ...
        <table id="YSDTable" class="table table-bordered" style="font-size: 16px;" >
            ...
            <tfoot>
                <tr style="text-align:center;" bgcolor="#b6dde8">
                    ...
                    <td id="REM_Total_Unit" style="font-weight: bold;" bgcolor="#c2efaa">&nbsp;</td>
                    <td id="REM_Total_Baht" style="font-weight: bold;" bgcolor="#c2efaa">&nbsp;</td>
                    <td id="MTD_Total_Unit" style="font-weight: bold;" bgcolor="#c2efaa">&nbsp;</td>
                    <td id="MTD_Total_Baht" style="font-weight: bold;" bgcolor="#c2efaa">&nbsp;</td>
                    <td id="SPD_Total_Unit" style="font-weight: bold;" bgcolor="#c2efaa">&nbsp;</td>
                    <td id="SPD_Total_Baht" style="font-weight: bold;" bgcolor="#c2efaa">&nbsp;</td>
                    <td id="ST_Total_Unit" style="font-weight: bold;" bgcolor="#c2efaa">&nbsp;</td>
                    <td id="ST_Total_Baht" style="font-weight: bold;" bgcolor="#c2efaa">&nbsp;</td>
            ...
            <tbody>
                <tr style="text-align:center;" bgcolor="#ffd699">
                    ...
                    <td id="REM_AB_Unit">&nbsp;</td>
                    <td id="REM_AB_Baht">&nbsp;</td>
                    <td id="MTD_AB_Unit">&nbsp;</td>
                    <td id="MTD_AB_Baht">&nbsp;</td>
                    <td id="SPD_AB_Unit">&nbsp;</td>
                    <td id="SPD_AB_Baht">&nbsp;</td>
                    <td id="ST_AB_Unit">&nbsp;</td>
                    <td id="ST_AB_Baht">&nbsp;</td>
                ...
                <tr style="text-align:center;" bgcolor="#ffd699">
                    ...
                    <td id="REM_MB_Unit">&nbsp;</td>
                    <td id="REM_MB_Baht">&nbsp;</td>
                    <td id="MTD_MB_Unit">&nbsp;</td>
                    <td id="MTD_MB_Baht">&nbsp;</td>
                    <td id="SPD_MB_Unit">&nbsp;</td>
                    <td id="SPD_MB_Baht">&nbsp;</td>
                    <td id="ST_MB_Unit">&nbsp;</td>
                    <td id="ST_MB_Baht">&nbsp;</td>
                ...
                <tr style="text-align:center;" bgcolor="#ffd699">
                    ...
                    <td id="REM_EB_Unit">&nbsp;</td>
                    <td id="REM_EB_Baht">&nbsp;</td>
                    <td id="MTD_EB_Unit">&nbsp;</td>
                    <td id="MTD_EB_Baht">&nbsp;</td>  
                    <td id="SPD_EB_Unit">&nbsp;</td>
                    <td id="SPD_EB_Baht">&nbsp;</td>
                    <td id="ST_EB_Unit">&nbsp;</td>
                    <td id="ST_EB_Baht">&nbsp;</td>
                ...
                <tr style="text-align:center;" bgcolor="#ffd699">
                    ...
                    <td id="MTD_OT_Baht">&nbsp;</td>
                    <td id="SPD_OT_Unit">&nbsp;</td>
                    <td id="SPD_OT_Baht">&nbsp;</td>
                    <td id="ST_OT_Unit">&nbsp;</td>
                    <td id="ST_OT_Baht">&nbsp;</td>
