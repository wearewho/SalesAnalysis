    ...
    <div class="row">
        <div class="col-md-10">            
            <h2 class="page-header">
                <span>OEM-Export Sales Summary Report : </span>
        ...
        <div class="col-md-1">               
            <form action="{{ route('analysis.oex.salessummary.downloadPDF') }}" method="POST" id="downloadPDF"> 
    ...
    <div class="modal fade" id="modal-dataTable">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <h4 class="modal-title" id="headModal">OEM-Export Sales Summary: </h4>
                </div>
...
<script src="{{ URL::asset('js/salessummaryOEX.js') }}"></script> 
