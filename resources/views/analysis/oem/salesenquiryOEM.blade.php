    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box box-danger">
                ...
                <h3 class="box-title"><i class="fa fa-table"></i> <b>OEM Sales Enquiry</b></h3>
                </div>
                <div class="box-body">
                    <div class="row">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <h4 class="modal-title" id="headCustModal">OEM Sales Enquiry by Customer</h4>
                </div>
    ...
    <div class="modal fade" id="modal-itemDataTable">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="headItemModal">OEM Sales Enquiry by Product</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
    ...
    <div class="modal fade" id="modal-invoiceCustomerDataTable">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="headInvoiceCustModal">OEM Sales Enquiry by Invoice</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
    ...
    <div class="modal fade" id="modal-invoiceItemDataTable">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span></button>
                <h4 class="modal-title" id="headInvoiceItemModal">OEM Sales Enquiry by Invoice</h4>
                </div>
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-12">
...
<script src="{{ URL::asset('js/salesenquiryOEM.js') }}"></script> 
