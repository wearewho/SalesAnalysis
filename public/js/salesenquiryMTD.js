...
function selectDataTable(startYear, endYear, startDate, endDate) {
    $.ajax({
        url: '/SalesAnalysis/mtd/selectEnquiryDataTableMTD',
        type: "POST",
                                    ...
                                    return {
                                        ...
                                        table: {
                                            ...
                                            body: [
                                                ...
                                                [{ colSpan: 3, text: "MTD Sales Enquiry by Product: " + startDate + " - " + endDate, alignment: 'center', bold: true, fontSize: 11 }],
                                            ]
                                    ...
                                    return {
                                        ...
                                        table: {
                                            ...
                                            body: [
                                                ...
                                                [{ colSpan: 3, text: "MTD Sales Enquiry by Customer: " + startDate + " - " + endDate, alignment: 'center', bold: true, fontSize: 11 }],
                                            ]
...
function selectDataTableModal(type, typeItem, data, startDate, endDate, startYear, endYear, desp) {
    var idItem = data;
    $.ajax({
        url: '/SalesAnalysis/mtd/selectEnquiryDataTableModalMTD',
        type: "POST",
        ...
        success: function(data, statusText, resObject) {
            ...
            if (data) {
                ...
                if (type == "findCustomer") {
                                        ...
                                        return {
                                            ...
                                            table: {
                                                ...
                                                body: [
                                                    ...
                                                    [{ colSpan: 3, text: "MTD Sales Enquiry (" + desp + ") by Customer : " + startDate + " - " + endDate, alignment: 'center', bold: true, fontSize: 11 }],
                                                ]
                    ...
                    $("#headCustModal").text("MTD Sales Enquiry by Customer :" + startDate + " - " + endDate);
                                        ...
                                        return {
                                            ...
                                            table: {
                                                ...
                                                body: [
                                                    ...
                                                    [{ colSpan: 3, text: "MTD Sales Enquiry (" + desp + ") by Product : " + startDate + " - " + endDate, alignment: 'center', bold: true, fontSize: 11 }],
                                                ]
                    ...
                    $("#headItemModal").text("MTD Sales Enquiry by Product :" + startDate + " - " + endDate);
                    ...
                    var buttonsProduct = new $.fn.dataTable.Buttons(tableProduct, {
                        buttons: [
                            'print',
                            {
                                extend: 'excel',
                                footer: true,
                                title: "MTD Sales Enquiry by Invoice : " + startDate + " - " + endDate
                            }, {
                                extend: 'pdf',
                                footer: true,
                                orientation: 'portrait', //landscape
                                pageSize: 'A4', //A3 , A5 , A6 , legal , letter
                                filename: "MTD Sales Enquiry by Invoice : " + startDate + " - " + endDate,
                                title: "MTD Sales Enquiry by Invoice : " + startDate + " - " + endDate,
                                exportOptions: {
                                    columns: [0, 1, 2, 3, 4, 5, 6, 7],
                                    search: 'applied',
                                        ...
                                        return {
                                            ...
                                            table: {
                                                ...
                                                body: [
                                                    ...
                                                    [{ colSpan: 3, text: "MTD Sales Enquiry (" + desp + ") by Invoice : " + startDate + " - " + endDate, alignment: 'center', bold: true, fontSize: 11 }],
                                                ]
                    ...
                    $("#headInvoiceItemModal").text("MTD Sales Enquiry by Invoice :" + startDate + " - " + endDate);
                    ...
                    var buttonsProduct = new $.fn.dataTable.Buttons(tableProduct, {
                        buttons: [
                            'print',
                            {
                                extend: 'excel',
                                footer: true,
                                title: "MTD Enquiry by Invoice : " + startDate + " - " + endDate
                            }, {
                                extend: 'pdf',
                                footer: true,
                                orientation: 'portrait', //landscape
                                pageSize: 'A4', //A3 , A5 , A6 , legal , letter
                                filename: "MTD Enquiry by Invoice : " + startDate + " - " + endDate,
                                title: "MTD Enquiry by Invoice : " + startDate + " - " + endDate,
                                exportOptions: {
                    ...
                    $("#headInvoiceCustModal").text("MTD Sales Enquiry by Invoice : " + startDate + " - " + endDate);
