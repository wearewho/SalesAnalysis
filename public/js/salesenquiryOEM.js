...
function selectDataTable(startYear, endYear, startDate, endDate) {
    $.ajax({
        url: '/SalesAnalysis/oem/selectEnquiryDataTableOEM',
        type: "POST",
                ...
                new $.fn.dataTable.Buttons(tableProduct, {
                    buttons: [
                        'print',
                        {
                            extend: 'excel',
                            footer: true,
                            title: "OEM Sales Enquiry by Product: " + startDate + " - " + endDate,
                            exportOptions: {
                                    ...
                                    return {
                                        ...
                                        table: {
                                            ...
                                            body: [
                                                ...
                                                [{ colSpan: 3, text: "OEM Sales Enquiry by Product: " + startDate + " - " + endDate, alignment: 'center', bold: true, fontSize: 11 }],
                                            ]
                ...
                new $.fn.dataTable.Buttons(tableCustomer, {
                    buttons: [
                        'print',
                        {
                            extend: 'excel',
                            footer: true,
                            title: "OEM Sales Enquiry by Customer: " + startDate + " - " + endDate,
                            exportOptions: {
                                    ...
                                    return {
                                        ...
                                        table: {
                                            ...
                                            body: [
                                                ...
                                                [{ colSpan: 3, text: "OEM Sales Enquiry by Customer: " + startDate + " - " + endDate, alignment: 'center', bold: true, fontSize: 11 }],
                                            ]
...
function selectDataTableModal(type, typeItem, data, startDate, endDate, startYear, endYear, desp) {
    var idItem = data;
    $.ajax({
        url: '/SalesAnalysis/oem/selectEnquiryDataTableModalOEM',
        type: "POST",
        ...
        success: function(data, statusText, resObject) {
            ...
            if (data) {
                ...
                if (type == "findCustomer") {
                    ...
                    var buttonsCustomer = new $.fn.dataTable.Buttons(tableCustomer, {
                        buttons: [
                            'print',
                            {
                                ...
                                orientation: 'portrait', //landscape
                                pageSize: 'A4', //A3 , A5 , A6 , legal , letter
                                filename: "OEM Sales Enquiry by Customer: " + startDate + " - " + endDate,
                                title: "OEM Sales Enquiry by Customer: " + startDate + " - " + endDate,
                                exportOptions: {
                                    columns: [0, 1, 2, 3, 4, 5, 6],
                                    search: 'applied',
                                        ...
                                        return {
                                            ...
                                            table: {
                                                ...
                                                body: [
                                                    ...
                                                    [{ colSpan: 3, text: "OEM Sales Enquiry (" + desp + ") by Customer : " + startDate + " - " + endDate, alignment: 'center', bold: true, fontSize: 11 }],
                                                ]
                    ...
                    $("#headCustModal").text("OEM Sales Enquiry by Customer :" + startDate + " - " + endDate);
                    ...
                    var buttonsProduct = new $.fn.dataTable.Buttons(tableProduct, {
                        buttons: [
                            'print',
                            {
                                extend: 'excel',
                                footer: true,
                                title: "OEM Enquiry by Product: " + startDate + " - " + endDate,
                                exportOptions: {
                                    columns: [0, 1, 2, 3, 4, 5, 6, 7],
                                    search: 'applied',
                                    order: 'applied'
                                ...
                                orientation: 'portrait', //landscape
                                pageSize: 'A4', //A3 , A5 , A6 , legal , letter
                                filename: "OEM Enquiry by Product: " + startDate + " - " + endDate,
                                title: "OEM Enquiry by Product: " + startDate + " - " + endDate,
                                exportOptions: {
                                    columns: [0, 1, 2, 3, 4, 5, 6, 7],
                                    search: 'applied',
                                        ...
                                        return {
                                            ...
                                            table: {
                                                ...
                                                body: [
                                                    ...
                                                    [{ colSpan: 3, text: "OEM Sales Enquiry (" + desp + ") by Product : " + startDate + " - " + endDate, alignment: 'center', bold: true, fontSize: 11 }],
                                                ]
                    ...
                    $("#headItemModal").text("OEM Sales Enquiry by Product :" + startDate + " - " + endDate);
                    ...
                    var buttonsProduct = new $.fn.dataTable.Buttons(tableProduct, {
                        buttons: [
                            'print',
                            {
                                extend: 'excel',
                                footer: true,
                                title: "OEM Sales Enquiry by Invoice : " + startDate + " - " + endDate
                            }, {
                                extend: 'pdf',
                                footer: true,
                                orientation: 'portrait', //landscape
                                pageSize: 'A4', //A3 , A5 , A6 , legal , letter
                                filename: "OEM Sales Enquiry by Invoice : " + startDate + " - " + endDate,
                                title: "OEM Sales Enquiry by Invoice : " + startDate + " - " + endDate,
                                exportOptions: {
                                    columns: [0, 1, 2, 3, 4, 5, 6, 7],
                                    search: 'applied',
                                        ...
                                        return {
                                            ...
                                            table: {
                                                ...
                                                body: [
                                                    ...
                                                    [{ colSpan: 3, text: "OEM Sales Enquiry (" + desp + ") by Invoice : " + startDate + " - " + endDate, alignment: 'center', bold: true, fontSize: 11 }],
                                                ]
                    ...
                    $("#headInvoiceItemModal").text("OEM Sales Enquiry by Invoice :" + startDate + " - " + endDate);
                    ...
                    var buttonsProduct = new $.fn.dataTable.Buttons(tableProduct, {
                        buttons: [
                            'print',
                            {
                                extend: 'excel',
                                footer: true,
                                title: "OEM Enquiry by Invoice : " + startDate + " - " + endDate
                            }, {
                                extend: 'pdf',
                                footer: true,
                                orientation: 'portrait', //landscape
                                pageSize: 'A4', //A3 , A5 , A6 , legal , letter
                                filename: "OEM Enquiry by Invoice : " + startDate + " - " + endDate,
                                title: "OEM Enquiry by Invoice : " + startDate + " - " + endDate,
                                exportOptions: {
                    ...
                    $("#headInvoiceCustModal").text("OEM Sales Enquiry by Invoice : " + startDate + " - " + endDate);
